    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 items-start">
      ...
      <div>
        ...
        <ul class="space-y-1 text-sm">
          ...
          <li><a href="#" class="hover:text-purple-400">Montpellier</a></li>
          <li><a href="#" class="hover:text-purple-400">Lyon</a></li>
          <li><a href="#" class="hover:text-purple-400">Bordeaux</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-1 text-sm">
          ...
          <li><a href="#" class="hover:text-purple-400">Politique de retours</a></li>
      ...
      <div class="flex flex-col items-start">
        ...
        <div class="flex space-x-4 text-xl">
          ...
          <a href="#" aria-label="Instagram" class="hover:text-purple-400">
            <i class="pi pi-instagram"></i>
          </a>
          <a href="#" aria-label="X" class="hover:text-purple-400">
